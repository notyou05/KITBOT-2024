...
public class LaunchNote extends Command {
  ...
  public LaunchNote(CANLauncher launcher, double power) {
    // save the launcher system internally
    m_launcher = launcher;
    m_power = power;
  ...
  public void initialize() {
    ...
    m_launcher.setLaunchWheel(kTopLaunchSpeed*m_power);
    m_launcher.setFeedWheel(kBottomLaunchSpeed);
    System.out.println("LauncNote");
  }
