...
import static frc.robot.Constants.LauncherConstants.kTopLaunchSpeed;
...
public class PrepareLaunch extends Command {
  ...
  public PrepareLaunch(CANLauncher launcher, DoubleSupplier speed) {
  ...
  public void initialize() {
    ...
    m_launcher.setLaunchWheel(kTopLaunchSpeed * m_speedSupplier.getAsDouble());
  }
  ...
  public void execute() {
    ...
    m_launcher.setLaunchWheel(kTopLaunchSpeed);
  }
